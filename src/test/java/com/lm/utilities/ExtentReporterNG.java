...
public class ExtentReporterNG extends TestListenerAdapter {
	...
	public void onStart(ITestContext testContext) {
		...
		htmlReporter = new ExtentHtmlReporter(System.getProperty("user.dir") + "/reports/" + repName);// specify
																										// location of
																										// the report
	...
	public void onTestSuccess(ITestResult tr) {
		...
		logger.log(Status.PASS, MarkupHelper.createLabel(tr.getName(), ExtentColor.GREEN)); // send the passed
																							...
																							// with GREEN coloString screenshotPath = System.getProperty("user.dir") + "/screenshots/" + tr.getName() + ".png";
